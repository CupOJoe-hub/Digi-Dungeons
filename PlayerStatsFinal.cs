...
public class PlayerStats : MonoBehaviour
{
    ...
    //Collects Game Manager Object using "DataManager" tag
    private void Start() {
        manager = GameObject.FindGameObjectWithTag("DataManager").GetComponent<DataManager>();
    }
    ...
    //Starts Game, Referenced Through A Button
    public void StartGame() {
        if(nameInput.text == "" || difficultyInput.text == "" || hasPlayedInput.text == "") {
            return;
        }
        if(hasPlayed == true) {
